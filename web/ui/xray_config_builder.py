            ...
            inbounds.append(
                {
                    ...
                    "streamSettings": {
                        ...
                        "tlsSettings": {
                            ...
                            "certificates": [
                                {
                                    "certificateFile": form.get("tls_cert", ""),
                                    "keyFile": form.get("tls_key", ""),
                                }
                            ],
                            "minVersion": "1.2",
                            "maxVersion": "1.3",
